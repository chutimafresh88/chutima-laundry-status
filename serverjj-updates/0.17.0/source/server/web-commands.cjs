...
const Purchasing=require('./purchase-workflow.cjs');
...
class WebCommands{
  ...
  async snapshot(){
    return this.engine.transaction(async db=>{
      ...
      records.push({collection:'meta',id:'catalog',body:{dashboard,categories:snapshot.categories,purchaseWorkflowVersion:1,reportVersion:1}});
